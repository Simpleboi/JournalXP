  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-violet-100/50 via-rose-50/30 to-amber-50/40" />
        ...
        <motion.div
          ...
          animate={{
            background: [
              'radial-gradient(ellipse at 20% 20%, rgba(167, 139, 250, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(251, 191, 36, 0.2) 0%, transparent 50%)',
              'radial-gradient(ellipse at 40% 40%, rgba(251, 113, 133, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 60% 60%, rgba(167, 139, 250, 0.2) 0%, transparent 50%)',
              'radial-gradient(ellipse at 20% 20%, rgba(167, 139, 250, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(251, 191, 36, 0.2) 0%, transparent 50%)',
            ],
          }}
          transition={{
        ...
        <FloatingShape
          className="absolute top-10 left-[10%] w-64 h-64 rounded-full bg-gradient-to-br from-violet-200/40 to-purple-300/30 blur-3xl"
          delay={0}
          duration={15}
        />
        <FloatingShape
          className="absolute top-20 right-[15%] w-48 h-48 rounded-full bg-gradient-to-br from-rose-200/40 to-pink-300/30 blur-3xl"
          delay={2}
          duration={18}
        />
        <FloatingShape
          className="absolute bottom-10 left-[30%] w-56 h-56 rounded-full bg-gradient-to-br from-amber-200/40 to-yellow-300/30 blur-3xl"
          delay={4}
          duration={20}
        />
        <FloatingShape
          className="absolute bottom-20 right-[25%] w-40 h-40 rounded-full bg-gradient-to-br from-sky-200/40 to-blue-300/30 blur-3xl"
          delay={1}
          duration={16}
        />
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-24 max-w-4xl text-center">
          ...
          >
            {/* Icon badge */}
            <motion.div
              className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-white/80 backdrop-blur-sm shadow-lg shadow-violet-200/50"
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-3 font-light">
              Gentle journeys for self-discovery
            </p>
      ...
      {/* Main Content */}
      <main id="main-content" className="relative container mx-auto px-4 py-8 max-w-4xl">
        <PathList />
      </main>
    </div>
  );
