...
const updates = [
  {
    ...
    content: [
      "🔒 [Habit Builder] When creating a habit, you can now choose the option to make a habit infinte, rather than indefinite. Allowing you to practice a habit without a requency",
      "[Journal] when you click on a Journal entry in the reflection archvie, it displays the time as well as the date"
    ],
  },
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-sm">
                What's New in JournalXP v2.0.1
              </h3>
